...
resnet_model = Model(inputs = resnet_model.layers[0].input, outputs = resnet_model.layers[379].output)
...
resnet_one_fnn_layer = Sequential([
                           data_augmentation,
                           resnet_model,
                           Dense(N_BREEDS, activation = 'softmax')
])

resnet_two_fnn_layers = Sequential([
                           data_augmentation,
                           resnet_model,
...
resnet_three_fnn_layers = Sequential([
                           data_augmentation,
                           resnet_model,
